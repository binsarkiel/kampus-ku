    ...
    <div class="container">
        ...
        <form id="form_mahasiswa" action="form_edit.php" method="post">
            ...
            <div class="d-flex align-items-center">
                <input type="text" name="nim" id="nim" value="<?php echo $nim ?>" readonly placeholder="Contoh: 12345678" class="form-control me-2">
            ...
            <div class="d-flex align-items-center">
                <input type="text" name="ipk" id="ipk" value="<?php echo $ipk ?>" class="form-control me-2">
                <span class="col-auto text-end text-muted">(angka desimal dipisah dengan karakter titik ".")</span>
            </div>
            </p>
            <p class="text-center">
                <input type="submit" name="submit" value="Update Data" class="btn btn-outline-primary w-100 my-2">
            </p>
        </form>
        <hr>
        <div id="footer">
